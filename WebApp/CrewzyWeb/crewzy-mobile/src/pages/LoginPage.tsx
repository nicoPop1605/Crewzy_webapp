...
import { Mail, Lock, Eye, EyeOff, UserPlus, Building2, User } from 'lucide-react';
...
export function LoginPage() {
    ...
    // Starea nouă pentru tipul de cont
    const [accountType, setAccountType] = useState<'personal' | 'business'>('personal');

    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();

        // AICI salvăm rolul în telefon/browser, ca să știm cine s-a logat!
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            <div className="flex p-1 bg-gray-100 rounded-xl mb-6">
                                <button
                                    ...
                                    className={`flex-1 flex items-center justify-center gap-2 py-2 text-sm font-semibold rounded-lg transition-all ${accountType === 'personal'
                                ...
                                <button
                                    ...
                                    className={`flex-1 flex items-center justify-center gap-2 py-2 text-sm font-semibold rounded-lg transition-all ${accountType === 'business'
                            ...
                            {isSignUp && (
                                <div>
                                    <label className="text-sm font-semibold text-gray-900 mb-2 block">
                                        {accountType === 'business' ? 'Business/Venue Name' : 'Full Name'}
                                    </label>
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            placeholder={accountType === 'business' ? "e.g. The Velvet Lounge" : "Enter your full name"}
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        placeholder={accountType === 'business' ? "contact@yourvenue.com" : "Enter your email"}
                                        className="w-full bg-gray-50 rounded-xl pl-12 pr-4 py-3 border border-gray-200 focus:border-gray-900 outline-none transition-colors"
                                        required
                                    />
                                </div>
                            ...
                            >
                                {isSignUp
                                    ...
                                    : (accountType === 'business' ? 'Sign In as Business' : 'Sign In')}
                            </button>

                            {/* Divider & Social Login (Hidden for Business accounts, optional) */}
                            {accountType === 'personal' && (
                                <>
                                    ...
                                    <div className="grid grid-cols-2 gap-3 mt-6">
                                        <button type="button" className="flex items-center justify-center gap-2 py-3 bg-gray-50 border border-gray-200 rounded-xl font-medium text-gray-700 hover:bg-gray-100 transition-colors">
